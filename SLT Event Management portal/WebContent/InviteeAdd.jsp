...
<title>Invitee Add | Event Management Admin Portal</title>
	...
	<div id="" class="container-fluid" style="background-color: #0d022b;">
		<div class="row vh-100">
			...
			<div id="" class="col-2 sidebar pr-0">
				...
				<div>
					<a class="active" href="InviteeAdd.jsp"><i
			...
			<div class="col-10 event " style="background-color: white;">
				...
				<div class="px-5 mx-4">
					<h2 class="mb-3" style="font-family: Calibri Light;">New Invitee
						</h2>
					<div class="forms">
						<form id="register" name="InviteeAdd" action="InviteeAdd"
							method="POST">
							...
							<div class="form-row">
								...
								<div class="form-group col-sm-8">
									<input type="email" class="form-control form-control-sm"
										id="inputEmail" placeholder="johndoe@example.com" name="email" required>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-sm-3">
								...
								<div class="form-group col-sm-8">
									<input type="text" class="form-control form-control-sm"
										id="nic" placeholder="987654321V" name="nic" required>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-sm-3">
								...
								<div class="form-group col-sm-8">
									<input type="text" class="form-control form-control-sm"
										id="inputPhone" name="phone" placeholder="0777123456" required>
								</div>
							</div>
							<br>
							<div class="form-row">
