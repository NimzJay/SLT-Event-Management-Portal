...
<title>Event Delete | Event Management Admin Portal</title>
	...
	<div id="" class="container-fluid" style="background-color: #0d022b;">
		<div class="row vh-100">
			...
			<div class="col-10 event " style="background-color: white;">
				...
				<div class="px-5 mx-4">
					<h2 class="" style="font-family: Calibri Light;">Delete Event
						</h2>
					<div class="forms">
						<div class="forms">
							<form action="EventDelete" class="EventDelete" method="POST" name="admin">
								<div class="form-row">
									...
									<div class="form-group col-sm-4">
										<input class="form-control form-control-sm"
											type="text" id="eid" name="eid" required />
									</div>
