...
<title>Invitee Update | Event Management Admin Portal</title>
	...
	<div id="" class="container-fluid" style="background-color: #0d022b;">
		<div class="row vh-100">
			...
			<div id="" class="col-2 sidebar pr-0">
				...
				<div>
					<a class="active" href="InviteeUpdate.jsp"><i
			...
			<div class="col-10 event " style="background-color: white;">
				...
				<div class="px-5 mx-4">
					<h2 class="" style="font-family: Calibri Light;">Update
						Invitee</h2>
					<div class="forms">
						<div class="forms">
							<form class="InviteeAdd" method="POST" name="admin">
								<div class="form-row">
						...
						<div class="forms">
							<%
								...
								try {
									String sql = ("SELECT * FROM sltemp_user WHERE nic = '" + nicc + "'");
									Connection con = DBconnection.getconn();
									PreparedStatement st = con.prepareStatement(sql);
									ResultSet rs = st.executeQuery(sql);
									while (rs.next()) {
							%>
							<form id="register" action="InviteeUpdate" method="POST"
								name="admin">
								<div class="form-row">
									<div class="col-sm-3">
									...
									<div class="form-group col-sm-4">
										<input type="text" class="form-control form-control-sm"
											name="fname" value="<%=rs.getString("fname")%>" required>
									</div>
									<div class="form-group col-sm-4">
										<input type="text" class="form-control form-control-sm"
											name="lname" value="<%=rs.getString("lname")%>" required>
									</div>
								</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-sm-8">
										<input type="text" class="form-control form-control-sm"
											name="user" value="<%=rs.getString("username")%>" required>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-sm-3">
									...
									<div class="form-group col-sm-8">
										<input type="password" class="form-control form-control-sm"
											id="pass" value="<%=rs.getString("password")%>" name="pass"
											required>
									</div>
								</div>
								<div class="form-row">
									...
									<div class="form-group col-sm-8">
										<input type="email" class="form-control form-control-sm"
											id="inputEmail" value="<%=rs.getString("email")%>"
											name="email" required>
									</div>
								</div>
								<div class="form-row">
									...
									<div class="form-group col-sm-8">
										<input type="text" class="form-control form-control-sm"
											id="nic" value="<%=rs.getString("nic")%>" name="nic" required>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-sm-3">
									...
									<div class="form-group col-sm-8">
										<input type="text" class="form-control form-control-sm"
											id="mobile" name="mobile" value="<%=rs.getString("mobile")%>"
											required>
									</div>
								</div>
